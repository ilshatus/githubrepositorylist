...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                .antMatcher("/**")
                .authorizeRequests()
                    .antMatchers("/", "/login**", "/webjars/**", "/error**", "/js/**", "/css/**")
                    .permitAll()
                .anyRequest()
                    .authenticated()
                .and()
                .logout()
                    .logoutSuccessUrl("/")
                    .logoutSuccessHandler(new LogoutSuccessHandlerImpl(historyRepository))
                    .permitAll()
                .and()
                .csrf()
    ...
    private Filter ssoFilter() {
        ...
        filter.setAuthenticationSuccessHandler(new AuthenticationSuccessHandlerImpl(historyRepository));
        return filter;
    }
